...
class PurchaseValidation extends Validation
{
    ...
    public function __invoke($request)
    {
        $requestValidator = [
            ...
            'paymentIndicator' => v::stringVal()->length(0, 100),
            'paymentType' => v::stringVal()->length(0, 100),
            'recurringAmountType' => v::stringVal()->length(0, 100),
            ...
            'securityCode' => v::stringVal()->length(0, 6),
            'personDocumentType' => v::stringVal()->in(self::PERSON_DOCUMENT_TYPE, true),
            'personDocumentNumber' => v::stringVal()->length(0, 20),
            'threeDSEci' => v::stringVal()->length(0, 100),
            'threeDSDirectoryServerTransactionId' => v::stringVal()->length(0, 700),
            'threeDSSecVersion' => v::stringVal()->length(0, 10),
            'threeDSAcctAuthValue' => v::stringVal()->length(0, 100),
            'softDescMarcTerminal' => v::stringVal()->length(0, 100),
            'softDescFacilitatorId' => v::stringVal()->length(0, 100),
            'softDescSalesOrgId' => v::stringVal()->length(0, 100),
            'softDescSubMerchId' => v::stringVal()->length(0, 30),
        ];
